; ModuleID = 'C:/HOC/HW_SW/zynq-book-master/hls/tut3A/matrix_mult_prj/solution3/.autopilot/db/a.g.ld.5.gdce.bc'
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @copy_out([5 x [5 x i8]]* noalias, [5 x [5 x i8]]* noalias readonly align 512, [5 x [5 x i8]]* noalias, [5 x [5 x i8]]* noalias readonly align 512, [5 x [5 x i16]]* noalias, [5 x [5 x i16]]* noalias readonly align 512) unnamed_addr #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @copy_back([5 x [5 x i8]]* noalias, [5 x [5 x i8]]* noalias readonly align 512, [5 x [5 x i8]]* noalias, [5 x [5 x i8]]* noalias readonly align 512, [5 x [5 x i16]]* noalias, [5 x [5 x i16]]* noalias readonly align 512) unnamed_addr #3 {
entry:
  call fastcc void @onebyonecpy_hls.p0a5a5i16([5 x [5 x i16]]* %4, [5 x [5 x i16]]* align 512 %5)
  ret void
}

define void @matrix_mult_hw_stub_wrapper([5 x i8]*, [5 x i8]*, [5 x i16]*) #4 {
entry:
