...
set ArgLastReadFirstWriteLatency {
	matrix_mult {
		...
		prod {Type O LastRead -1 FirstWrite 12}}}
...
set Spec2ImplPortList { 
	a { ap_memory {  { a_address0 mem_address 1 5 }  { a_ce0 mem_ce 1 1 }  { a_q0 in_data 0 8 }  { a_address1 MemPortADDR2 1 5 }  { a_ce1 MemPortCE2 1 1 }  { a_q1 MemPortDOUT2 0 8 } } }
	b { ap_memory {  { b_address0 mem_address 1 5 }  { b_ce0 mem_ce 1 1 }  { b_q0 in_data 0 8 }  { b_address1 MemPortADDR2 1 5 }  { b_ce1 MemPortCE2 1 1 }  { b_q1 MemPortDOUT2 0 8 } } }
