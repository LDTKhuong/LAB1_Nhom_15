...
architecture behav of matrix_mult is 
    ...
    "matrix_mult_matrix_mult,hls_ip_2022_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=5.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=3.610000,HLS_SYN_LAT=258,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=383,HLS_SYN_LUT=507,HLS_VERSION=2022_2}";
    ...
    signal icmp_ln10_reg_435 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln10_fu_164_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln10_reg_435_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln10_reg_435_pp0_iter2_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal k_load_reg_439 : STD_LOGIC_VECTOR (2 downto 0);
    signal icmp_ln12_fu_188_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln12_reg_444 : STD_LOGIC_VECTOR (0 downto 0);
    signal select_ln10_1_fu_194_p3 : STD_LOGIC_VECTOR (2 downto 0);
    signal select_ln10_1_reg_450 : STD_LOGIC_VECTOR (2 downto 0);
    signal and_ln10_fu_214_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln10_reg_457 : STD_LOGIC_VECTOR (0 downto 0);
    signal or_ln12_fu_220_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal or_ln12_reg_462 : STD_LOGIC_VECTOR (0 downto 0);
    signal or_ln12_reg_462_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal or_ln12_reg_462_pp0_iter2_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln12_1_fu_226_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal add_ln12_1_reg_468 : STD_LOGIC_VECTOR (5 downto 0);
    signal add_ln16_1_fu_257_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal add_ln16_1_reg_473 : STD_LOGIC_VECTOR (4 downto 0);
    signal ap_block_pp0_stage1_11001 : BOOLEAN;
    signal select_ln12_fu_269_p3 : STD_LOGIC_VECTOR (2 downto 0);
    signal select_ln12_reg_478 : STD_LOGIC_VECTOR (2 downto 0);
    signal select_ln12_2_fu_275_p3 : STD_LOGIC_VECTOR (2 downto 0);
    signal select_ln12_2_reg_483 : STD_LOGIC_VECTOR (2 downto 0);
    signal zext_ln16_1_fu_282_p1 : STD_LOGIC_VECTOR (4 downto 0);
    signal zext_ln16_1_reg_489 : STD_LOGIC_VECTOR (4 downto 0);
    signal add_ln16_2_fu_286_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal add_ln16_2_reg_494 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal icmp_ln15_1_fu_343_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal zext_ln16_2_fu_321_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal zext_ln16_3_fu_356_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage1 : BOOLEAN;
    signal zext_ln13_1_fu_377_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal select_ln12_3_fu_298_p3 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal add_ln10_1_fu_170_p2 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal zext_ln16_fu_247_p1 : STD_LOGIC_VECTOR (4 downto 0);
    signal select_ln10_fu_240_p3 : STD_LOGIC_VECTOR (2 downto 0);
    signal add_ln12_fu_263_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal zext_ln13_fu_313_p1 : STD_LOGIC_VECTOR (4 downto 0);
    signal tmp_1_fu_325_p3 : STD_LOGIC_VECTOR (4 downto 0);
    signal add_ln16_3_fu_332_p2 : STD_LOGIC_VECTOR (4 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_1 = ap_condition_199)) then
                if ((icmp_ln10_fu_164_p2 = ap_const_lv1_0)) then 
                    indvar_flatten15_fu_86 <= add_ln10_1_fu_170_p2;
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_enable_reg_pp0_iter0 = ap_const_logic_1)) then
                if ((ap_const_boolean_1 = ap_condition_426)) then 
                    ...
                    indvar_flatten_fu_78 <= select_ln12_3_fu_298_p3;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then
                a_load_reg_529 <= a_q0;
                prod_addr_reg_549 <= zext_ln13_1_fu_377_p1(5 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln10_fu_164_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                add_ln12_1_reg_468 <= add_ln12_1_fu_226_p2;
                and_ln10_reg_457 <= and_ln10_fu_214_p2;
                icmp_ln12_reg_444 <= icmp_ln12_fu_188_p2;
                k_load_reg_439 <= ap_sig_allocacmp_k_load;
                or_ln12_reg_462 <= or_ln12_fu_220_p2;
                select_ln10_1_reg_450 <= select_ln10_1_fu_194_p3;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                add_ln13_reg_505 <= add_ln13_fu_316_p2;
                add_ln13_reg_505_pp0_iter2_reg <= add_ln13_reg_505;
                add_ln13_reg_505_pp0_iter3_reg <= add_ln13_reg_505_pp0_iter2_reg;
                add_ln16_4_reg_515 <= add_ln16_4_fu_337_p2;
                icmp_ln10_reg_435 <= icmp_ln10_fu_164_p2;
                icmp_ln10_reg_435_pp0_iter1_reg <= icmp_ln10_reg_435;
                icmp_ln10_reg_435_pp0_iter2_reg <= icmp_ln10_reg_435_pp0_iter1_reg;
                icmp_ln15_1_reg_520 <= icmp_ln15_1_fu_343_p2;
                icmp_ln15_1_reg_520_pp0_iter2_reg <= icmp_ln15_1_reg_520;
                icmp_ln15_1_reg_520_pp0_iter3_reg <= icmp_ln15_1_reg_520_pp0_iter2_reg;
                or_ln12_reg_462_pp0_iter1_reg <= or_ln12_reg_462;
                or_ln12_reg_462_pp0_iter2_reg <= or_ln12_reg_462_pp0_iter1_reg;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln10_reg_435 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then
                add_ln15_reg_499 <= add_ln15_fu_292_p2;
                add_ln16_1_reg_473 <= add_ln16_1_fu_257_p2;
                add_ln16_2_reg_494 <= add_ln16_2_fu_286_p2;
                select_ln12_2_reg_483 <= select_ln12_2_fu_275_p3;
                select_ln12_reg_478 <= select_ln12_fu_269_p3;
                    zext_ln16_1_reg_489(2 downto 0) <= zext_ln16_1_fu_282_p1(2 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_enable_reg_pp0_iter3 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then
                add_ln16_reg_554 <= grp_fu_385_p3;
            end if;
        end if;
    end process;
    zext_ln16_1_reg_489(4 downto 3) <= "00";
    ...
    a_address0 <= zext_ln16_2_fu_321_p1(5 - 1 downto 0);
    ...
    add_ln10_1_fu_170_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_indvar_flatten15_load) + unsigned(ap_const_lv7_1));
    add_ln10_fu_182_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_load) + unsigned(ap_const_lv3_1));
    add_ln12_1_fu_226_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_indvar_flatten_load) + unsigned(ap_const_lv6_1));
    add_ln12_fu_263_p2 <= std_logic_vector(unsigned(select_ln10_fu_240_p3) + unsigned(ap_const_lv3_1));
    add_ln13_fu_316_p2 <= std_logic_vector(unsigned(add_ln16_1_reg_473) + unsigned(zext_ln13_fu_313_p1));
    add_ln15_fu_292_p2 <= std_logic_vector(unsigned(select_ln12_fu_269_p3) + unsigned(ap_const_lv3_1));
    add_ln16_1_fu_257_p2 <= std_logic_vector(unsigned(tmp_fu_250_p3) + unsigned(zext_ln16_fu_247_p1));
    add_ln16_2_fu_286_p2 <= std_logic_vector(unsigned(add_ln16_1_fu_257_p2) + unsigned(zext_ln16_1_fu_282_p1));
    add_ln16_3_fu_332_p2 <= std_logic_vector(unsigned(zext_ln16_1_reg_489) + unsigned(tmp_1_fu_325_p3));
    add_ln16_4_fu_337_p2 <= std_logic_vector(unsigned(add_ln16_3_fu_332_p2) + unsigned(zext_ln13_fu_313_p1));
    ...
    ap_condition_124_assign_proc : process(ap_CS_fsm_pp0_stage1, icmp_ln10_reg_435, ap_block_pp0_stage1_11001)
    begin
                ap_condition_124 <= ((icmp_ln10_reg_435 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1));
    end process;
    ...
    ap_condition_426_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_11001, ap_loop_init)
    begin
                ap_condition_426 <= ((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1));
    end process;


    ap_condition_exit_pp0_iter0_stage1_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1_subdone, icmp_ln10_reg_435)
    begin
        if (((icmp_ln10_reg_435 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage1_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
    ...
    ap_condition_exit_pp0_iter3_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter3, icmp_ln10_reg_435_pp0_iter2_reg, ap_block_pp0_stage0_subdone)
    begin
        if (((icmp_ln10_reg_435_pp0_iter2_reg = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter3 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_sig_allocacmp_k_load_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter1, add_ln15_reg_499, ap_block_pp0_stage0, ap_loop_init, k_fu_70)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
            if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_loop_init = ap_const_logic_1))) then 
                ap_sig_allocacmp_k_load <= ap_const_lv3_0;
            elsif ((ap_enable_reg_pp0_iter1 = ap_const_logic_1)) then 
                ap_sig_allocacmp_k_load <= add_ln15_reg_499;
            else 
    ...
    b_address0 <= zext_ln16_3_fu_356_p1(5 - 1 downto 0);
    ...
    grp_fu_385_p2 <= 
        ap_const_lv16_0 when (or_ln12_reg_462_pp0_iter2_reg(0) = '1') else 
        ap_sig_allocacmp_p_load;
    icmp_ln10_fu_164_p2 <= "1" when (ap_sig_allocacmp_indvar_flatten15_load = ap_const_lv7_7D) else "0";
    icmp_ln12_fu_188_p2 <= "1" when (ap_sig_allocacmp_indvar_flatten_load = ap_const_lv6_19) else "0";
    icmp_ln15_1_fu_343_p2 <= "1" when (add_ln15_reg_499 = ap_const_lv3_5) else "0";
    ...
    select_ln10_fu_240_p3 <= 
        ap_const_lv3_0 when (icmp_ln12_reg_444(0) = '1') else 
        j_fu_74;
    select_ln12_2_fu_275_p3 <= 
        add_ln12_fu_263_p2 when (and_ln10_reg_457(0) = '1') else 
        select_ln10_fu_240_p3;
    select_ln12_3_fu_298_p3 <= 
        ap_const_lv6_1 when (icmp_ln12_reg_444(0) = '1') else 
        add_ln12_1_reg_468;
    select_ln12_fu_269_p3 <= 
        ap_const_lv3_0 when (or_ln12_reg_462(0) = '1') else 
        k_load_reg_439;
    tmp_1_fu_325_p3 <= (select_ln12_reg_478 & ap_const_lv2_0);
    tmp_fu_250_p3 <= (select_ln10_1_reg_450 & ap_const_lv2_0);
    xor_ln10_fu_202_p2 <= (icmp_ln12_fu_188_p2 xor ap_const_lv1_1);
    zext_ln13_1_fu_377_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln13_reg_505_pp0_iter3_reg),64));
    zext_ln13_fu_313_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(select_ln12_2_reg_483),5));
    zext_ln16_1_fu_282_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(select_ln12_fu_269_p3),5));
    zext_ln16_2_fu_321_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln16_2_reg_494),64));
    zext_ln16_3_fu_356_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln16_4_reg_515),64));
    zext_ln16_fu_247_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(select_ln10_1_reg_450),5));
end behav;
