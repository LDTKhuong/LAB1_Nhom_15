; ModuleID = 'C:/HOC/HW_SW/zynq-book-master/hls/tut3A/matrix_mult_prj/solution5/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  %a_copy.gep3 = getelementptr [5 x i40], [5 x i40]* %a_copy1, i64 0, i32 0
  %3 = getelementptr inbounds [5 x [5 x i16]], [5 x [5 x i16]]* %prod_copy, i32 0, i32 0
  call void @llvm.sideeffect() #6 [ "xlx_array_reshape"(i40* %a_copy.gep3, i32 998, i32 1, i32 0) ], !dbg !5
  call void @llvm.sideeffect() #6 [ "xlx_array_reshape"([5 x i40]* %b_copy2, i32 998, i32 1, i32 0) ], !dbg !374
  call void @apatb_matrix_mult_hw([5 x i40]* %a_copy1, [5 x i40]* %b_copy2, [5 x i16]* %3)
...
for.loop2:                                        ; preds = %for.loop2, %for.loop
  ...
  %dst.addr57 = getelementptr [5 x [5 x i16]], [5 x [5 x i16]]* %0, i64 0, i64 %for.loop.idx10, i64 %for.loop.idx39
  %src.addr68 = getelementptr [5 x [5 x i16]], [5 x [5 x i16]]* %1, i64 0, i64 %for.loop.idx10, i64 %for.loop.idx39
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a5a5i8.3.4([5 x i40]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [5 x [5 x i8]]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
  %2 = icmp eq [5 x i40]* %0, null
...
for.loop:                                         ; preds = %for.loop.split, %copy
  %for.loop.idx10 = phi i64 [ 0, %copy ], [ %for.loop.idx.next, %for.loop.split ]
  %dst.addr571 = getelementptr [5 x i40], [5 x i40]* %0, i64 0, i64 %for.loop.idx10
  %dst.addr571.promoted = load i40, i40* %dst.addr571, align 8
  br label %for.loop2

for.loop2:                                        ; preds = %for.loop2, %for.loop
  %5 = phi i40 [ %dst.addr571.promoted, %for.loop ], [ %14, %for.loop2 ]
  %for.loop.idx39 = phi i64 [ 0, %for.loop ], [ %for.loop.idx3.next, %for.loop2 ]
...
for.loop.split:                                   ; preds = %for.loop2
  store i40 %14, i40* %dst.addr571, align 8
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx10, 1
  %exitcond11 = icmp ne i64 %for.loop.idx.next, 5
  br i1 %exitcond11, label %for.loop, label %ret
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a5a5i8.5.6([5 x i40]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [5 x [5 x i8]]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
  %2 = icmp eq [5 x i40]* %0, null
  %3 = icmp eq [5 x [5 x i8]]* %1, null
  %4 = or i1 %2, %3
...
for.loop2:                                        ; preds = %for.loop2, %for.loop
  %for.loop.idx39 = phi i64 [ 0, %for.loop ], [ %for.loop.idx3.next, %for.loop2 ]
  %dst.addr571 = getelementptr [5 x i40], [5 x i40]* %0, i64 0, i64 %for.loop.idx39
  %src.addr68 = getelementptr [5 x [5 x i8]], [5 x [5 x i8]]* %1, i64 0, i64 %for.loop.idx10, i64 %for.loop.idx39
  %9 = load i8, i8* %src.addr68, align 1
  %10 = load i40, i40* %dst.addr571, align 8
  %11 = zext i8 %9 to i40
  %12 = shl i40 %11, %6
  %13 = and i40 %10, %8
  %14 = or i40 %13, %12
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_in([5 x [5 x i8]]* noalias readonly "orig.arg.no"="0", [5 x i40]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1", [5 x [5 x i8]]* noalias readonly "orig.arg.no"="2", [5 x i40]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3", [5 x [5 x i16]]* noalias readonly "orig.arg.no"="4", [5 x [5 x i16]]* noalias align 512 "orig.arg.no"="5") #3 {
entry:
  call void @onebyonecpy_hls.p0a5a5i8.3.4([5 x i40]* align 512 %1, [5 x [5 x i8]]* %0)
  call void @onebyonecpy_hls.p0a5a5i8.5.6([5 x i40]* align 512 %3, [5 x [5 x i8]]* %2)
  call fastcc void @onebyonecpy_hls.p0a5a5i16([5 x [5 x i16]]* align 512 %5, [5 x [5 x i16]]* %4)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a5a5i8.11.12([5 x [5 x i8]]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [5 x i40]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
  %2 = icmp eq [5 x [5 x i8]]* %0, null
  %3 = icmp eq [5 x i40]* %1, null
  %4 = or i1 %2, %3
  br i1 %4, label %ret, label %copy
...
for.loop:                                         ; preds = %for.loop.split, %copy
  %for.loop.idx10 = phi i64 [ 0, %copy ], [ %for.loop.idx.next, %for.loop.split ]
  %src.addr681 = getelementptr [5 x i40], [5 x i40]* %1, i64 0, i64 %for.loop.idx10
  %5 = load i40, i40* %src.addr681, align 8
  br label %for.loop2
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a5a5i8.13.14([5 x [5 x i8]]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [5 x i40]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
  %2 = icmp eq [5 x [5 x i8]]* %0, null
  %3 = icmp eq [5 x i40]* %1, null
  %4 = or i1 %2, %3
...
for.loop2:                                        ; preds = %for.loop2, %for.loop
  %for.loop.idx39 = phi i64 [ 0, %for.loop ], [ %for.loop.idx3.next, %for.loop2 ]
  %dst.addr57 = getelementptr [5 x [5 x i8]], [5 x [5 x i8]]* %0, i64 0, i64 %for.loop.idx10, i64 %for.loop.idx39
  %src.addr681 = getelementptr [5 x i40], [5 x i40]* %1, i64 0, i64 %for.loop.idx39
  %7 = load i40, i40* %src.addr681, align 8
  %8 = lshr i40 %7, %6
  %9 = trunc i40 %8 to i8
  store i8 %9, i8* %dst.addr57, align 1
  %for.loop.idx3.next = add nuw nsw i64 %for.loop.idx39, 1
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_out([5 x [5 x i8]]* noalias "orig.arg.no"="0", [5 x i40]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1", [5 x [5 x i8]]* noalias "orig.arg.no"="2", [5 x i40]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3", [5 x [5 x i16]]* noalias "orig.arg.no"="4", [5 x [5 x i16]]* noalias readonly align 512 "orig.arg.no"="5") #4 {
entry:
  call void @onebyonecpy_hls.p0a5a5i8.11.12([5 x [5 x i8]]* %0, [5 x i40]* align 512 %1)
  call void @onebyonecpy_hls.p0a5a5i8.13.14([5 x [5 x i8]]* %2, [5 x i40]* align 512 %3)
  call fastcc void @onebyonecpy_hls.p0a5a5i16([5 x [5 x i16]]* %4, [5 x [5 x i16]]* align 512 %5)
  ret void
}

declare void @apatb_matrix_mult_hw([5 x i40]*, [5 x i40]*, [5 x i16]*)

; Function Attrs: argmemonly noinline norecurse
define internal void @copy_back([5 x [5 x i8]]* noalias "orig.arg.no"="0", [5 x i40]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1", [5 x [5 x i8]]* noalias "orig.arg.no"="2", [5 x i40]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3", [5 x [5 x i16]]* noalias "orig.arg.no"="4", [5 x [5 x i16]]* noalias readonly align 512 "orig.arg.no"="5") #4 {
entry:
  call fastcc void @onebyonecpy_hls.p0a5a5i16([5 x [5 x i16]]* %4, [5 x [5 x i16]]* align 512 %5)
  ret void
}

define void @matrix_mult_hw_stub_wrapper([5 x i40]*, [5 x i40]*, [5 x i16]*) #5 {
entry:
  %3 = alloca [5 x [5 x i8]]
  %4 = alloca [5 x [5 x i8]]
  %5 = bitcast [5 x i16]* %2 to [5 x [5 x i16]]*
  call void @copy_out([5 x [5 x i8]]* %3, [5 x i40]* %0, [5 x [5 x i8]]* %4, [5 x i40]* %1, [5 x [5 x i16]]* null, [5 x [5 x i16]]* %5)
  ...
  call void @copy_in([5 x [5 x i8]]* %3, [5 x i40]* %0, [5 x [5 x i8]]* %4, [5 x i40]* %1, [5 x [5 x i16]]* null, [5 x [5 x i16]]* %5)
  ret void
}
...
!7 = !DIFile(filename: "C:/HOC/HW_SW/zynq-book-master/hls/tut3A/matrix_mult_prj/solution5/directives.tcl", directory: "C:\5CHOC\5CHW_SW\5Czynq-book-master\5Chls\5Ctut3A")
...
!9 = !DIFile(filename: "matrix_mult.cpp", directory: "C:\5CHOC\5CHW_SW\5Czynq-book-master\5Chls\5Ctut3A")
...
!15 = !DIFile(filename: "./matrix_mult.h", directory: "C:\5CHOC\5CHW_SW\5Czynq-book-master\5Chls\5Ctut3A")
...
!27 = !DIFile(filename: "C:/HOC/HW_SW/zynq-book-master/hls/tut3A/matrix_mult_prj/solution5/.autopilot/db\5Cmatrix_mult.pp.0.cpp", directory: "C:\5CHOC\5CHW_SW\5Czynq-book-master\5Chls\5Ctut3A")
...
!32 = !DIFile(filename: "C:/APP/VIVADO/Vitis_HLS/2022.2/tps/mingw/8.3.0/win64.o/nt\5Cx86_64-w64-mingw32\5Cinclude\5Cmath.h", directory: "C:\5CHOC\5CHW_SW\5Czynq-book-master\5Chls\5Ctut3A")
!33 = !DISubroutineType(types: !34)
!34 = !{!35, !35}
!35 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!36 = !DIFile(filename: "C:/APP/VIVADO/Vitis_HLS/2022.2/tps/mingw/8.3.0/win64.o/nt\5Clib\5Cgcc\5Cx86_64-w64-mingw32\5C8.3.0\5Cinclude\5Cc++\5Cbits/std_abs.h", directory: "C:\5CHOC\5CHW_SW\5Czynq-book-master\5Chls\5Ctut3A")
...
!42 = !DIFile(filename: "C:/APP/VIVADO/Vitis_HLS/2022.2/tps/mingw/8.3.0/win64.o/nt\5Clib\5Cgcc\5Cx86_64-w64-mingw32\5C8.3.0\5Cinclude\5Cc++\5Ccmath", directory: "C:\5CHOC\5CHW_SW\5Czynq-book-master\5Chls\5Ctut3A")
